...
public:
    ...
    void retranslateUi(QWidget *timers_main_area)
    {
        ...
        timeEdit_hours->setToolTip(QApplication::translate("timers_main_area", "<html><head/><body><p>The <span style=\" font-weight:600;\">hour</span> interval that the timer will go off at</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        timeEdit_minutes->setToolTip(QApplication::translate("timers_main_area", "<html><head/><body><p>The <span style=\" font-weight:600;\">minute</span> interval that the timer will go off at</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        timeEdit_seconds->setWhatsThis(QApplication::translate("timers_main_area", "<html><head/><body><p>The <span style=\" font-weight:600;\">second</span> interval that the timer will go off at</p></body></html>", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_WHATSTHIS
        timeEdit_msecs->setWhatsThis(QApplication::translate("timers_main_area", "<html><head/><body><p>The <span style=\" font-weight:600;\">milisecond</span> interval that the timer will go off at (1000 miliseconds = 1 second)</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_WHATSTHIS
        timeEdit_msecs->setDisplayFormat(QApplication::translate("timers_main_area", "z", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("timers_main_area", "<html><head/><body><p>(hours <span style=\" font-weight:600;\">:</span> minutes <span style=\" font-weight:600;\">:</span> seconds <span style=\" font-weight:600;\">:</span> miliseconds)</p></body></html>", 0, QApplication::UnicodeUTF8));
