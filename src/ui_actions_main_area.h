...
public:
    ...
    void setupUi(QWidget *actions_main_area)
    {
        ...
        actions_main_area->resize(900, 351);
        ...
        sizePolicy3.setHeightForWidth(label_action_name_4->sizePolicy().hasHeightForWidth());
        label_action_name_4->setSizePolicy(sizePolicy3);
        ...
        sizePolicy.setHeightForWidth(css->sizePolicy().hasHeightForWidth());
        css->setSizePolicy(sizePolicy);
        QFont font;
        ...
        pushButton_chose_icon->setGeometry(QRect(9, 21, 80, 27));
        QSizePolicy sizePolicy5(QSizePolicy::Preferred, QSizePolicy::Fixed);
        sizePolicy5.setHorizontalStretch(0);
        sizePolicy5.setVerticalStretch(0);
        sizePolicy5.setHeightForWidth(pushButton_chose_icon->sizePolicy().hasHeightForWidth());
        pushButton_chose_icon->setSizePolicy(sizePolicy5);
        pushButton_color = new QPushButton(widget_3);
        pushButton_color->setObjectName(QString::fromUtf8("pushButton_color"));
        pushButton_color->setEnabled(false);
        pushButton_color->setGeometry(QRect(9, 66, 80, 27));
        sizePolicy5.setHeightForWidth(pushButton_color->sizePolicy().hasHeightForWidth());
        pushButton_color->setSizePolicy(sizePolicy5);
        ...
        sizePolicy6.setHeightForWidth(optionsArea->sizePolicy().hasHeightForWidth());
        optionsArea->setSizePolicy(sizePolicy6);
        ...
        sizePolicy1.setHeightForWidth(buttonColumns->sizePolicy().hasHeightForWidth());
        buttonColumns->setSizePolicy(sizePolicy1);
        QFont font1;
        ...
        sizePolicy2.setHeightForWidth(useCustomLayout->sizePolicy().hasHeightForWidth());
        useCustomLayout->setSizePolicy(sizePolicy2);
        ...
        formLayout = new QFormLayout(useCustomLayout);
    ...
    void retranslateUi(QWidget *actions_main_area)
    {
        ...
        label_action_name_4->setText(QApplication::translate("actions_main_area", "Button stylesheet:", 0, QApplication::UnicodeUTF8));
