...
public:
    ...
    void setupUi(QDialog *profile_preferences)
    {
        ...
        profile_preferences->resize(744, 576);
        ...
        mapper_tab->setObjectName(QString::fromUtf8("mapper_tab"));
        ...
        mapper_profiles_combobox->setObjectName(QString::fromUtf8("mapper_profiles_combobox"));

        gridLayout_3->addWidget(mapper_profiles_combobox, 2, 1, 1, 2);

        copy_map_profile = new QPushButton(groupBox_3);
        copy_map_profile->setObjectName(QString::fromUtf8("copy_map_profile"));
        ...
        map_file_action->setObjectName(QString::fromUtf8("map_file_action"));
        ...
        sizePolicy5.setHeightForWidth(closeButton->sizePolicy().hasHeightForWidth());
        closeButton->setSizePolicy(sizePolicy5);
        QIcon icon;
    ...
    {
        profile_preferences->setWindowTitle(QApplication::translate("profile_preferences", "Profile preferences", 0, QApplication::UnicodeUTF8));
...
"or some other computer model that has a small screen.", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_3->setTitle(QApplication::translate("profile_preferences", "Map files", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("profile_preferences", "Load another map file in:", 0, QApplication::UnicodeUTF8));
        load_map_button->setText(QApplication::translate("profile_preferences", "Pick map file", 0, QApplication::UnicodeUTF8));
        copy_map_profile->setText(QApplication::translate("profile_preferences", "Copy", 0, QApplication::UnicodeUTF8));
        label_12->setText(QApplication::translate("profile_preferences", "Copy map to another profile:", 0, QApplication::UnicodeUTF8));
        save_map_button->setText(QApplication::translate("profile_preferences", "Pick location", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("profile_preferences", "Save your current map:", 0, QApplication::UnicodeUTF8));
        map_file_action->setText(QApplication::translate("profile_preferences", "An action above happened", 0, QApplication::UnicodeUTF8));
        downloadMapOptions->setTitle(QApplication::translate("profile_preferences", "Map download", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        label_11->setToolTip(QApplication::translate("profile_preferences", "<html><head/><body><p>On MUDs that provide maps for download (currently IRE games only), you can press this button to get the latest map. Note that this will <span style=\" font-weight:600;\">overwrite</span> any changes you've done to your map, and will use the new map only</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_11->setText(QApplication::translate("profile_preferences", "Download latest map provided by your MUD:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        buttonDownloadMap->setToolTip(QApplication::translate("profile_preferences", "<html><head/><body><p>On MUDs that provide maps for download (currently IRE games only), you can press this button to get the latest map. Note that this will <span style=\" font-weight:600;\">overwrite</span> any changes you've done to your map, and will use the new map only</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        buttonDownloadMap->setText(QApplication::translate("profile_preferences", "Download", 0, QApplication::UnicodeUTF8));
        groupBox_12->setTitle(QApplication::translate("profile_preferences", "Map backups", 0, QApplication::UnicodeUTF8));
        label_13->setText(QApplication::translate("profile_preferences", "Delete map backups older than:", 0, QApplication::UnicodeUTF8));
        label_14->setText(QApplication::translate("profile_preferences", "days since today, keeping newer and monthly backups", 0, QApplication::UnicodeUTF8));
        groupBox_5->setTitle(QApplication::translate("profile_preferences", "Map view", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_WHATSTHIS
        mMapperUseAntiAlias->setWhatsThis(QApplication::translate("profile_preferences", "<html><head/><body><p>This enables anti-aliasing (AA) for tha map view, making it look smother and nicer</p></body></html>", 0, QApplication::UnicodeUTF8));
        ...
        tabWidgeta->setTabText(tabWidgeta->indexOf(mapper_tab), QApplication::translate("profile_preferences", "Mapper", 0, QApplication::UnicodeUTF8));
        ...
        tabWidgeta->setTabText(tabWidgeta->indexOf(tab_4), QApplication::translate("profile_preferences", "Mapper colors", 0, QApplication::UnicodeUTF8));
